...
public final class FakeDeckApi implements DeckApi {
  ...
  public String createDeckSync(int deckCount) {
  ...
  public List<Card> getDeck(String deckId) {
  ...
  @Override public Single<ShuffleDeckResponse> createDeck(int deckCount) {
    ...
    return Single.fromCallable(() -> {
      ...
      return new ShuffleDeckResponse(deckId);
    });
  }
  ...
  @Override public Single<DrawCardsResponse> draw(String deckId, int cardCount) {
    ...
    return Single.fromCallable(() -> {
      ...
      return new DrawCardsResponse(drawnCards);
    });
  }
